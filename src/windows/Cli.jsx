...
const Cli = ({ windowname, setwindow }) => {
  const commands = {
    ...
    about: {
      ...
      usage: "about",
      fn: () =>
        "Hi! I'm Ankit, a high-performance Full-Stack Engineer. I specialize in building scalable web applications with React, Node.js, and modern system architectures. ",
    },
    skills: {
...
3. E-commerce Dashboard: MERN stack admin panel with real-time analytics.`,
    ...
    socials: {
      ...
      usage: "socials",
      fn: () =>
        "Opening LinkedIn... (Just kidding, use the 'contact' command for links!)",
    },
  };
